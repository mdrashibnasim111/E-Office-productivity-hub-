...
export default function LoginPage() {
  return (
    <div className="w-full min-h-screen grid place-items-center p-4 bg-[#0F1822] relative overflow-hidden">
      <div className="w-full max-w-[300px] rounded-lg bg-card/30 border border-primary/20 backdrop-blur-lg px-8 py-12 shadow-2xl text-foreground flex flex-col items-center text-center z-10">
