  ...
  return (
    <>
      ...
      <Card 
        ...
        style={{ '--shadow-color': 'hsl(var(--primary) / 0.4)', backgroundImage: 'linear-gradient(to bottom, #17222c, #26404f, #346173, #418596, #50abb7, #50abb7, #50abb7, #50abb7, #418596, #346173, #26404f, #17222c)' } as React.CSSProperties}
